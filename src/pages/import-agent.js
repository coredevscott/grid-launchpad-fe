...
export default function CreateAgent() {
    ...
    return (
    <>  
        <div ref={modal} className="fixed inset-0 hidden justify-center items-center bg-[#0B0B0F76] z-50">
            <div className="bg-[#0D3563] rounded-2xl lg:rounded-[53px] text-white p-12 relative">
                ...
                <section className="grid md:grid-cols-2 text-center gap-8">
                    <div className="flex flex-col p-8 gap-4 bg-[#092F5B] rounded-[30px]">
                        <Image src="/images/Group 48096156.svg" className="w-20 mx-auto" width={84} height={87} alt="" />
                        <p className="audiowide-regular text-xl">Launch a new Token</p>
                    </div>
                    ...
                    <Link href="/import-agent" className="flex flex-col p-8 gap-4 bg-[#092F5B] rounded-[30px]">
                        ...
                        <p className="audiowide-regular text-xl">I have my own token</p>
                    </Link>                
                </section>
            </div>
        </div>

        <div className="create-agent bg-contain bg-top bg-no-repeat relative md:bg-none">
            ...
            <div className="relative mt-20">
                ...
                <section className="refer-banner flex flex-col lg:flex-row gap-4 items-center justify-between mx-6 rounded-2xl p-4 mt-16 md:w-2/3 md:mx-auto">
                    ...
                    <button className="baloo-bhaijaan-2 text-xl bg-gradient-to-tr from-[#0B62D0] to-[#A3D4FF] px-8 py-3 border-[1px] border-solid border-white rounded-[10px] w-full lg:w-fit lg:py-2">Search</button>
                </section>
                ...
                <section className="bg-gradient-to-t from-[#0B62D042] to-[#1784E242] rounded-2xl border-[1px] border-solid border-white/40 p-4 m-6 lg:my-12 lg:mx-24">
                    <div className="grid md:grid-cols-2 gap-4">
                        <div className="flex flex-col gap-6">
                            <div className="h-full relative bg-[#08203B] border-[1px] border-solid border-white rounded-2xl p-8">
                                ...
                                <div className="flex flex-col justify-center items-center h-full">
                                    ...
                                    <p className="inter text-xl">Upload Image</p>
                                </div>
                            </div>

                            <label className="audiowide-regular text-white">Bio</label>
                            <input type="text" className="p-3 md:p-4 bg-white/15 border-[1px] border-solid border-white/10 rounded-xl" />
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <label className="audiowide-regular text-white">Token Contract Address on Sol Chain</label>
                            <input type="text" className="p-3 md:p-4 bg-white/15 border-[1px] border-solid border-white/10 rounded-xl" />

                            <div className="flex justify-between items-center">
                            <label className="audiowide-regular text-white">Visisbility</label>
                                <div className="w-fit flex items-center gap-4">
                                    <p className="audiowide-regular text-[#1AEDFE]">Public</p>
                                    <label for="AcceptConditions" className="relative inline-block h-6 w-10 cursor-pointer rounded-full bg-[#1AEDFE] transition [-webkit-tap-highlight-color:_transparent]">
                                        <input type="checkbox" id="AcceptConditions" className="peer sr-only" />
                                        <span className="absolute inset-y-0 start-0 m-1 size-4 rounded-full bg-[#31557B] transition-all peer-checked:start-4"></span>
                                    </label>
                                </div>
                            </div>
                            
                            <label className="audiowide-regular text-white">Agent Type</label>
                            <select className="p-3 md:p-4 bg-[#31547A] border-[1px] border-solid border-white/10 rounded-xl pr-24">
                    ...
                    <div className="mt-6">
                        ...
                        <textarea className="p-3 md:p-4 bg-white/15 border-[1px] border-solid border-white/10 rounded-xl h-56 w-full mt-6"></textarea>
                    </div>
                </section>
            </div>
        </div>
